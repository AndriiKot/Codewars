  ...
  hash_languages.each do |key, value|
    if key == 'python'
      template += <<~EOF
        ...
        ##### [5-kyu: #{folders_count_5}](https://github.com/AndriiKot/Python__CodeWars/tree/main/kyu-5)

        ##### [6-kyu: #{folders_count_6}](https://github.com/AndriiKot/Python__CodeWars/tree/main/kyu-6)

        ##### [7-kyu: #{folders_count_7}](https://github.com/AndriiKot/Python__CodeWars/tree/main/kyu-7)
